  ...
  <div id="rec622692140" class="r t-rec t-rec_pt_0 t-rec_pb_0"
    ...
    <div class="tmenu-mobile tmenu-mobile_positionfixed">
      <div class="tmenu-mobile__container">
        ...
        <button type="button" class="t-menuburger t-menuburger_second" aria-label="Navigation menu"
          aria-expanded="false">
    ...
    <div id="nav622692140"
      ...
      style="background-color: rgb(255, 255, 255); height: 65px;  top: 0; overflow: auto; max-height: calc(100% - 64px); opacity: 0;" data-bgcolor-hex="#ffffff"
      data-bgcolor-rgba="rgba(255,255,255,1)" data-navmarker="nav622692140marker" data-appearoffset="700px"
      data-bgopacity-two="100" data-menushadow="50" data-menushadow-css="" data-bgopacity="1"
          ...
          <div class="t228__leftcontainer">
            <a href="/" class="t228__imgwrapper">
              <img class="t228__imglogo t228__imglogomobile"
                src="/images/tild6534-3132-4064-a561-383963393838__expand-sqr.png" imgfield="img" style="
                      max-width: 70px;
                      width: 70px;
                      min-width: 70px;
                      height: auto;
        ...
        <div class="t228__centerside">
          <nav class="t228__centercontainer">
            <ul role="list" class="t228__list t-menu__list t228__list_hidden">
              ...
              <li class="t228__list_item" style="padding: 0 15px">
                <a class="t-menu__link-item" href="#contact" data-menu-submenu-hook="" data-menu-item-number="5">
                  Контакти
                </a>
              </li>
            </ul>
              ...
              <ul role="list" class="t-sociallinks__wrapper" aria-label="Social media links">
                ...
                <li class="t-sociallinks__item t-sociallinks__item_phone">
                  <a href="tel:+38 093 967 90 96" target="_blank" rel="nofollow" aria-label="phone"
                    style="width: 30px; height: 30px"><svg class="t-sociallinks__svg" role="presentation" width="30px"
                      height="30px" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
